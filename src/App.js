...
function App() {
  ...
  const [feedback, setFeedback] = useState(`You can now mint your own GOBLIN EGGS.`);
  ...
  const claimNFTs = () => {
    ...
    blockchain.smartContract.methods
      ...
      .then((receipt) => {
        console.log(receipt);
        setFeedback(
          `The ${CONFIG.NFT_NAME} The GOBLIN EGG is yours! You can see it on the Opensea Marketplace.`
        );
        setClaimingNft(false);
      ...
      <s.Container
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 0 }} test>
            ...
            <StyledImg style={{
              ...
              borderRadius: 0,
              border: "1px #b5597b",
              borderStyle: "solid none solid none",}} src={"/config/images/DC4-512.png"} />
            ...
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              <>
                ...
                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
                  You can still buy GOBLIN EGGS on the Opensea Marketplace.
                </s.TextDescription>
              </>
            ) : (
              <>
